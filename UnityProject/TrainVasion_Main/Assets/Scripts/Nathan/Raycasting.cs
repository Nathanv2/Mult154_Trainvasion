...
public class Raycasting : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (hit.collider.tag == "5 People" || hit.collider.tag == "10 People" || hit.collider.tag == "15 People" || hit.collider.tag == "Rescued" || hit.collider.tag == "Blockade" || hit.collider.tag == "Blockade Removed")
            {
