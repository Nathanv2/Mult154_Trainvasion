...
public class Waypoints : MonoBehaviour
{
    ...
    public Transform GetNextWaypoint(Transform currentWaypoint)
    {
        ...
        // Stores the indes of the next waypoint to travel towards
        ...
        if (isMovingForward)
        {
            ...
            // If the next waypoing index is equal to the count of children/waypoint then it is already at the last waypoint
